...
for i = 1, 30 do
	local img = display.newImage("Icon.png", math.random(10, __appContentWidth__ - 20), math.random(50, 150))
...
local function on_Collision(e)
	local other = e.other
	other.alpha = 0.4
end
dragBox:addEventListener("collision", on_Collision)
-------------------------------------